    ...
    <div>
        ...
        <Flex vertical>
            <Flex vertical className="px-8">
                ...
                <Paragraph>
                    Send a coupon to customers who finish their plates and complete the zero-waste challenge!
                </Paragraph>          
            </Flex>
            <Flex className="px-4">
        ...
        <Flex vertical className="py-8">
            ...
            <Flex className="px-4 pt-2">
                <Link onClick={handleManageCoupons}>
                    MANAGE YOUR COUPON OPTIONS
                </Link>
            </Flex> 
        </Flex>
        <Flex vertical center className="px-20 py-12">
            <CustomButton type="primary" onClick={handleSendCoupon} disabled={isButtonDisabled}>SEND COUPON</CustomButton>
        </Flex>
    </div>);
};
