  ...
  return (
    <div>
      ...
      <Flex vertical className="px-12">
        <Paragraph>
          Partner with PlateMate to bring the Zero-Waste Challenge to your
          restaurant. We offer:
        </Paragraph>
        <Flex vertical className="px-4">
          <ButtonText>• Financial Subsidies:</ButtonText>
          <Paragraph className="text-primary">
            Support to help you join our sustainable mission.
          </Paragraph>
          <ButtonText>• Increase Customer Loyalty:</ButtonText>
          <Paragraph className="text-primary">
            Attract and retain customers by offering rewards for participating
            in the Zero-Waste Challenge.
          </Paragraph>
        </Flex>
        <Paragraph>
